 ...
 * @see GenericDao
 */
public class GenericJpaDao<T extends BaseEntity, I extends Serializable> implements GenericDao<T, I> {

    private static final Logger logger = Logger.getLogger(GenericJpaDao.class.getName());
    ...
    public List<T> findAllBySeveralIds(List<Long> ids) {
    ...
    public T save(T entity) {
        try {
            ...
            logger.log(Level.SEVERE,"Error happened during persisting an object " + entity,ex);
